...
wget -O /etc/openvpn/easy-rsa/vars "https://raw.githubusercontent.com/SasukexSakura/AutoScriptSSH/main/vars.conf"
...
# install openvpn
wget -O /etc/openvpn/vpn.zip "https://github.com/SasukexSakura/AutoScriptSSH/raw/main/vpn.zip"
cd /etc/openvpn/
unzip vpn.zip
rm -f vpn.zip
cd
...
mkdir clientconfig
cp /etc/openvpn/{LUFFYxSENPAI.crt,EMBEX.key,ca.crt,ta.key} clientconfig/
cd clientconfig
